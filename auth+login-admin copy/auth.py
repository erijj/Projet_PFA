...
# ─── UTILISATEURS (remplacer par table BDD en prod) ───────
USERS: dict = {
    "admin@smartcert.tn": {
        "password": "admin123",
        "role":     "admin",
...
def login():
    ...
    if not user or user["password"] != password:
        # Délai volontaire anti-brute-force (en prod : utiliser bcrypt + rate-limit)
...
def verify_token():
    ...
    Appelé par auth_guard.js au chargement de chaque page protégée.
